...
public class UserCenterController {
    ...
    @ResponseBody
    public Result centerEdit(HttpServletRequest request, HttpServletResponse response, Model model, User user) {
        CookieUitl.set(response, "username",user.getUsername(),100000);
