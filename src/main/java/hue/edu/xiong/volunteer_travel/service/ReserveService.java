...
public class ReserveService {
    ...
    public Result cancelReserve(HttpServletRequest request, String id,String begindate,String enddate) {
        Cookie cookie = CookieUitl.get(request, "username");
        if (cookie == null) {
        ...
        if (userHotel != null) {
            ...
            newUserHotel.setBegindate(begindate);
            newUserHotel.setEnddate(enddate);
    ...
    @Transactional(rollbackFor = Exception.class)
    public Result cancelAttractionsReserve(HttpServletRequest request, String id,String begindate,String enddate) {
        Cookie cookie = CookieUitl.get(request, "username");
        if (cookie == null) {
            throw new ServiceException("用户没有登录!");
        }
        ...
        if (userAttractions != null) {
            ...
            newUserAttractions.setBegindate(begindate);
            newUserAttractions.setEnddate(enddate);
